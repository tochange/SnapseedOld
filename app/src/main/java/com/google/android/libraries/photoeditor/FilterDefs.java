...
public final class FilterDefs {
    ...
    public static class FilterParameterType {
        ...
        private static SparseArray<String> SERIALIZABLE_PARAMETER_NAME = new SparseArray(64);
        ...
        public static int getParameterId(String parameterName) {
            int index = FilterDefs.indexOfValue(SERIALIZABLE_PARAMETER_NAME, parameterName);
    ...
    public static class FilterType {
        ...
        private static SparseArray<String> SERIALIZABLE_FILTER_NAME = new SparseArray(24);
        ...
        public static int getFilterId(String filterName) {
            int index = FilterDefs.indexOfValue(SERIALIZABLE_FILTER_NAME, filterName);
    ...
    private static <E> int indexOfValue(SparseArray<E> sparseArray, E value) {
