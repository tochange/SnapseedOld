...
public class AutoEnhanceFilterParameter extends FilterParameter {
    public static final int[] GLOBAL_ADJUSTMENT_PARAMS = new int[]{3, 104, 0, 1, 5, 24, 25, 4, 2, 102, 101, 106, 107};
    ...
    public String getParameterDescription(Context context, int parameterType, Object parameterValue) {
        ...
        return String.format("%s %d", new Object[]{context.getString(R.string.style), (Integer) parameterValue});
    }
}
